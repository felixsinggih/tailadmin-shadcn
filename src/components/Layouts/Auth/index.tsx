...
export default function AuthLayout({
    ...
    return (
        <div className='flex h-screen items-center justify-center overflow-hidden bg-gray-1 dark:bg-boxdark-2 dark:text-bodydark'>
                            ...
                            <div className='flex flex-wrap items-center '>
                                <div className='hidden w-full xl:block xl:w-1/2'>
                                    <div className='px-[6.5rem] py-[4.375rem] text-center'>
                                        <Link className='mb-[1.375] inline-block' href='/'>
                                            <Image
