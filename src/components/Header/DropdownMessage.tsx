  ...
  return (
    <li className="relative">
      <Link
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray-1 hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
        href="#"
      >
        <span
        ...
        <MessageCircleMoreIcon size={20} strokeWidth={1.5} className='duration-300 ease-in-out' />
      </Link>
